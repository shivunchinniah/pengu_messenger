 ...
 *
 * Modified By Shivun Chinniah, Original Author Philipp Danner.
 */
public class ModernScrollPane extends JScrollPane {
    ...
    public ModernScrollPane(Component view) {
        ...
        this(view, VERTICAL_SCROLLBAR_AS_NEEDED, HORIZONTAL_SCROLLBAR_AS_NEEDED, THUMB_COLOR);
    ...
    public ModernScrollPane(Component view, Color thumbColor) {

        this(view, VERTICAL_SCROLLBAR_AS_NEEDED, HORIZONTAL_SCROLLBAR_AS_NEEDED, thumbColor);
        thumbCol = thumbColor;
    }

    public ModernScrollPane(int vsbPolicy, int hsbPolicy) {
        this(null, vsbPolicy, hsbPolicy, THUMB_COLOR);
    ...
    private void initComponents(){
        ...
        verticalScrollBar.setUI(new ModernScrollBarUI(this, thumbCol));
        
        //JScrollBar horizontalScrollBar = getHorizontalScrollBar();
        horizontalScrollBar.setOpaque(false);
        horizontalScrollBar.setUI(new ModernScrollBarUI(this, thumbCol));
    ...
    public ModernScrollPane(Component view, int vsbPolicy, int hsbPolicy, Color thumbColor) {
        thumbCol = thumbColor;
        initComponents();   
    ...
    private static class ModernScrollBarUI extends BasicScrollBarUI {
        ...
        public ModernScrollBarUI(ModernScrollPane sp, Color col) {
            this.sp = sp;
            this.thumbCol = col;
        }
        ...
        protected void paintThumb(Graphics g, JComponent c, Rectangle thumbBounds) {
            ...
            graphics2D.setColor(new Color(thumbCol.getRed(), thumbCol.getGreen(), thumbCol.getBlue(), alpha));
